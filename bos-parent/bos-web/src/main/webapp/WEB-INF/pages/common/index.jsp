...
<script type="text/javascript">
	...
	// 版权信息
	function showAbout(){
		$.messager.alert("宅急送 v1.0","管理员邮箱: 2224022091@qq.com");
	}
</script>
</head>
				...
				<tr>
					<td style="width: 300px;">
						<div style="color: #999; font-size: 8pt;">
							龙求道| Powered by <a href="https://github.com/LongQiudao/">LongQiudao</a>
						</div>
					</td>
				</tr>
			</tbody>
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                ...
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input required="required" data-options="validType:'length[3,10]'"
